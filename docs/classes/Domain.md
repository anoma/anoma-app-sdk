...
[@anomaorg/anoma-app-sdk](../globals.md) / Domain

# Class: Domain

Defined in: node\_modules/@types/node/domain.d.ts:25
...
> **members**: (`EventEmitter`\<`DefaultEventMap`\> \| `Timer`)[]

Defined in: node\_modules/@types/node/domain.d.ts:30
...
Defined in: node\_modules/@types/node/domain.d.ts:101
...
`EventEmitter`\<`DefaultEventMap`\> | `Timer`
...
Defined in: node\_modules/@types/node/domain.d.ts:131
...
Defined in: node\_modules/@types/node/domain.d.ts:42

The `enter()` method is plumbing used by the `run()`, `bind()`, and `intercept()` methods to set the active domain. It sets `domain.active` and `process.domain` to the domain, and implicitly
pushes the domain onto the domain
stack managed by the domain module (see [exit](#exit) for details on the
...
Defined in: node\_modules/@types/node/domain.d.ts:56
...
Defined in: node\_modules/@types/node/domain.d.ts:164

This method is almost identical to [bind](#bind). However, in
...
Defined in: node\_modules/@types/node/domain.d.ts:107

The opposite of [add](#add). Removes domain handling from the
specified emitter.
...
Defined in: node\_modules/@types/node/domain.d.ts:87
