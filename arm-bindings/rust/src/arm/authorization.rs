...
#[derive(Clone, Copy, Debug, Serialize, Deserialize, uniffi::Object)]
...
#[derive(Clone, Copy, Debug, Default, Serialize, Deserialize, PartialEq, uniffi::Object)]
...
impl AuthorityVerifyingKey {
    #[uniffi::constructor]
    pub fn new(pk_bytes: &[u8]) -> Result<AuthorityVerifyingKey, BindingsError> {
    ...
    #[uniffi::constructor]
    pub fn from_hex(pk_hex: &str) -> Result<AuthorityVerifyingKey, BindingsError> {
