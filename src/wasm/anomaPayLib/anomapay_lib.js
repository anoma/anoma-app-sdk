/* @ts-self-types="./anomapay_lib.d.ts" */
...
export class TransferLogic {
    static __wrap(ptr) {
        const obj = Object.create(TransferLogic.prototype);
        obj.__wbg_ptr = ptr;
        TransferLogicFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        TransferLogicFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_transferlogic_free(ptr, 0);
    }
    /**
     * Creates resource logic for a consumed persistent resource.
     * @param {ConsumedPersistentProps} props
     * @returns {TransferLogic}
     */
    static consumePersistentResourceLogic(props) {
        const ret = wasm.transferlogic_consumePersistentResourceLogic(props);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return TransferLogic.__wrap(ret[0]);
    }
    /**
    ...
    static create_persistent_resource_logic(props) {
        const ret = wasm.transferlogic_create_persistent_resource_logic(props);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return TransferLogic.__wrap(ret[0]);
    ...
    toJson() {
        ...
        try {
            const ptr = this.__destroy_into_raw();
            const ret = wasm.transferlogic_toJson(ptr);
            var ptr1 = ret[0];
            var len1 = ret[1];
            if (ret[3]) {
                ptr1 = 0; len1 = 0;
    ...
    static get verifyingKey() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.transferlogic_verifyingKey();
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
...
if (Symbol.dispose) TransferLogic.prototype[Symbol.dispose] = TransferLogic.prototype.free;
...
const TransferLogicFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_transferlogic_free(ptr, 1));
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('anomapay_lib_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
