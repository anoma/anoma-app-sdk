...
export class TransferLogic {
     ...
     */
    static consumePersistentResourceLogic(props: ConsumedPersistentProps): TransferLogic;
    /**
     * Creates resource logic for a created persistent resource.
     */
    static create_persistent_resource_logic(props: CreatePersistentProps): TransferLogic;
    toJson(): string;
...
export interface InitOutput {
    ...
    readonly __wbg_transferlogic_free: (a: number, b: number) => void;
    readonly transferlogic_verifyingKey: () => [number, number];
    readonly transferlogic_consumePersistentResourceLogic: (a: any) => [number, number, number];
    readonly transferlogic_create_persistent_resource_logic: (a: any) => [number, number, number];
    readonly transferlogic_toJson: (a: number) => [number, number, number, number];
