/* @ts-self-types="./anomapay_lib_v2.d.ts" */
...
export class AuthoritySignature {
    ...
    /**
     * @param {string} authtority_signature
     * @returns {AuthoritySignature}
     */
    static fromBase64(authtority_signature) {
        const ptr0 = passStringToWasm0(authtority_signature, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.authoritysignature_fromBase64(ptr0, len0);
        if (ret[2]) {
...
if (Symbol.dispose) AuthoritySignature.prototype[Symbol.dispose] = AuthoritySignature.prototype.free;
...
export class AuthoritySigningKey {
    ...
    authorize(domain, action_tree) {
        ...
        const ret = wasm.authoritysigningkey_authorize(this.__wbg_ptr, ptr0, len0, action_tree.__wbg_ptr);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return AuthoritySignature.__wrap(ret[0]);
    ...
    sign(domain, message) {
        ...
        const ret = wasm.authoritysigningkey_sign(this.__wbg_ptr, ptr0, len0, ptr1, len1);
...
if (Symbol.dispose) AuthoritySigningKey.prototype[Symbol.dispose] = AuthoritySigningKey.prototype.free;
...
export class AuthorityVerifyingKey {
    ...
    static fromBase64(authtority_signature) {
        const ptr0 = passStringToWasm0(authtority_signature, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.authorityverifyingkey_fromBase64(ptr0, len0);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
    ...
    static fromSigningKey(signing_key) {
        ...
        const ret = wasm.authorityverifyingkey_fromSigningKey(signing_key.__wbg_ptr);
    ...
    verify(domain, message, signature) {
        ...
        const ret = wasm.authorityverifyingkey_verify(this.__wbg_ptr, ptr0, len0, ptr1, len1, signature.__wbg_ptr);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
}
if (Symbol.dispose) AuthorityVerifyingKey.prototype[Symbol.dispose] = AuthorityVerifyingKey.prototype.free;
...
if (Symbol.dispose) HeliaxKeys.prototype[Symbol.dispose] = HeliaxKeys.prototype.free;
...
export class InitialRoot {
    ...
    static base64() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.initialroot_base64();
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
    ...
    hex() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.initialroot_hex(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
...
if (Symbol.dispose) InitialRoot.prototype[Symbol.dispose] = InitialRoot.prototype.free;
...
export class MerklePath {
    ...
    /**
     * @returns {EncodedMerklePath}
     */
    encode() {
        const ret = wasm.merklepath_encode(this.__wbg_ptr);
        return ret;
    }
    constructor() {
        const ret = wasm.merklepath_new();
        this.__wbg_ptr = ret;
        MerklePathFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
}
...
if (Symbol.dispose) NullifierKey.prototype[Symbol.dispose] = NullifierKey.prototype.free;
...
if (Symbol.dispose) NullifierKeyCommitment.prototype[Symbol.dispose] = NullifierKeyCommitment.prototype.free;
...
if (Symbol.dispose) NullifierKeyPair.prototype[Symbol.dispose] = NullifierKeyPair.prototype.free;
...
export class Resource {
     ...
     * @returns {Resource}
     */
    static create(logic_ref, label_ref, quantity, value_ref, is_ephemeral, nonce, nk_cmt) {
        ...
        const ret = wasm.resource_create(logic_ref.__wbg_ptr, label_ref.__wbg_ptr, quantity, quantity >> BigInt(64), value_ref.__wbg_ptr, is_ephemeral, nonce.__wbg_ptr, nk_cmt.__wbg_ptr);
...
export class ResourceBuilder {
    static __wrap(ptr) {
        const obj = Object.create(ResourceBuilder.prototype);
        obj.__wbg_ptr = ptr;
        ResourceBuilderFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        ResourceBuilderFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_resourcebuilder_free(ptr, 0);
    }
    /**
     * @param {CreateEphemeralResourceProps} props
     * @returns {ResourceBuilder}
     */
    static create_ephemeral_resource(props) {
        const ret = wasm.resourcebuilder_create_ephemeral_resource(props);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return ResourceBuilder.__wrap(ret[0]);
    }
    /**
     * @param {CreatePersistentResourceProps} props
     * @returns {ResourceBuilder}
     */
    static create_persistent_resource(props) {
        const ret = wasm.resourcebuilder_create_persistent_resource(props);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return ResourceBuilder.__wrap(ret[0]);
     ...
     */
    constructor(props) {
        const ret = wasm.resourcebuilder_new(props);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        this.__wbg_ptr = ret[0];
        ResourceBuilderFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
    /**
     * @returns {EncodedResource}
     */
    get resource() {
        const ret = wasm.resourcebuilder_resource(this.__wbg_ptr);
        return ret;
    }
    /**
     * @returns {string}
    ...
    toJson() {
        ...
        let deferred2_1;
        try {
            const ret = wasm.resourcebuilder_toJson(this.__wbg_ptr);
            var ptr1 = ret[0];
            var len1 = ret[1];
            if (ret[3]) {
                ptr1 = 0; len1 = 0;
    ...
    witness() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.resourcebuilder_witness(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
...
if (Symbol.dispose) ResourceBuilder.prototype[Symbol.dispose] = ResourceBuilder.prototype.free;
...
if (Symbol.dispose) ResourceWithLabel.prototype[Symbol.dispose] = ResourceWithLabel.prototype.free;
...
export class TransferLogicV2 {
    static __wrap(ptr) {
        const obj = Object.create(TransferLogicV2.prototype);
        obj.__wbg_ptr = ptr;
        TransferLogicV2Finalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        TransferLogicV2Finalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_transferlogicv2_free(ptr, 0);
    }
    /**
     * Creates resource logic for a consumed persistent resource.
     * @param {ConsumedPersistentProps} props
     * @returns {TransferLogicV2}
     */
    static consumePersistentResourceLogic(props) {
        const ret = wasm.transferlogicv2_consumePersistentResourceLogic(props);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return TransferLogicV2.__wrap(ret[0]);
    }
    /**
     * Creates resource logic for a created persistent resource.
     * @param {CreatePersistentProps} props
     * @returns {TransferLogicV2}
     */
    static create_persistent_resource_logic(props) {
        const ret = wasm.transferlogicv2_create_persistent_resource_logic(props);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return TransferLogicV2.__wrap(ret[0]);
    ...
    /**
     * @param {MigrateResourceLogicProps} props
     * @returns {TransferLogicV2}
     */
    static migrateResourceLogic(props) {
        const ret = wasm.transferlogicv2_migrateResourceLogic(props);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return TransferLogicV2.__wrap(ret[0]);
    ...
    toJson() {
        ...
        try {
            const ptr = this.__destroy_into_raw();
            const ret = wasm.transferlogicv2_toJson(ptr);
            var ptr1 = ret[0];
            var len1 = ret[1];
            if (ret[3]) {
                ptr1 = 0; len1 = 0;
     ...
     * @returns {string}
     */
    static get verifyingKey() {
        let deferred1_0;
        let deferred1_1;
        try {
            const ret = wasm.transferlogicv2_verifyingKey();
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
...
if (Symbol.dispose) TransferLogicV2.prototype[Symbol.dispose] = TransferLogicV2.prototype.free;
...
function __wbg_get_imports() {
    const import0 = {
        ...
        __wbg___wbindgen_shr_000c80f19751a589: function(arg0, arg1) {
            const ret = arg0 >> arg1;
            return ret;
        },
    ...
    return {
        __proto__: null,
        "./anomapay_lib_v2_bg.js": import0,
    };
}

const AuthoritySignatureFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_authoritysignature_free(ptr, 1));
const AuthoritySigningKeyFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_authoritysigningkey_free(ptr, 1));
const AuthorityVerifyingKeyFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_authorityverifyingkey_free(ptr, 1));
const CallTypeFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_calltype_free(ptr, 1));
...
const HeliaxKeysFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_heliaxkeys_free(ptr, 1));
const InitialRootFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_initialroot_free(ptr, 1));
const ResourceWithLabelFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_resourcewithlabel_free(ptr, 1));
...
const MerklePathFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_merklepath_free(ptr, 1));
const MerkleTreeFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_merkletree_free(ptr, 1));
const NullifierKeyFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_nullifierkey_free(ptr, 1));
const NullifierKeyCommitmentFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_nullifierkeycommitment_free(ptr, 1));
const NullifierKeyPairFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_nullifierkeypair_free(ptr, 1));
...
const ResourceFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_resource_free(ptr, 1));
const ResourceBuilderFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_resourcebuilder_free(ptr, 1));
...
const TransferLogicV2Finalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_transferlogicv2_free(ptr, 1));
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('anomapay_lib_v2_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
