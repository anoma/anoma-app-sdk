 ...
 */
export type EncodedMerklePath = EncodedMerkleLeaf[];

/**
 * Define encoded MerklePath leaf for interacting with Anoma SDK encoding
 */
export interface EncodedMerkleLeaf {
    node: string;
    left: boolean;
}
 ...
 */
export interface MigrateResourceProps {
    resource: ResourceProps;
    migratedResource: ResourceProps;
...
export interface ConsumedPersistentProps {
    resource: ResourceProps;
    actionTreeRoot: string;
    nfKey: string;
    authPk: string;
...
export interface CreateEphemeralResourceProps {
    forwarderAddress: string;
    erc20TokenAddr: string;
    ethereumAccountAddr: string;
    nfKey: string;
    quantity: bigint;
}

export interface CreatePersistentProps {
    resource: ResourceProps;
    actionTreeRoot: string;
    discoveryPk: string;
    authPk: string;
...
export interface CreatePersistentResourceProps {
    forwarderAddress: string;
    erc20TokenAddr: string;
    encryptionPk: string;
    nfKey: string;
...
export interface MigrateConsumedResourceProps {
    resource: ResourceProps;
    migratedResource: ResourceProps;
    actionTreeRoot: string;
    forwarderAddr: string;
...
export interface MigrateCreatedResourceProps {
    resource: ResourceProps;
    discoveryPk: string;
    authPk: string;
    encryptionPk: string;
...
export interface MigrateMigratedResourceProps {
    nfKey: string;
    resourcePath: string;
    authPk: string;
    encryptionPk: string;
...
export interface MigrateResourceLogicProps {
    resource: MigrateResourceProps;
    migratedResource: MigrateMigratedResourceProps;
    consumed: MigrateConsumedResourceProps;
}
...
export class AuthoritySignature {
    ...
    free(): void;
    [Symbol.dispose](): void;
    static fromBase64(authtority_signature: string): AuthoritySignature;
...
export class AuthorityVerifyingKey {
    free(): void;
    [Symbol.dispose](): void;
    static fromBase64(authtority_signature: string): AuthorityVerifyingKey;
    static fromHex(pk_hex: string): AuthorityVerifyingKey;
    static fromSigningKey(signing_key: AuthoritySigningKey): AuthorityVerifyingKey;
    constructor(pk_bytes: Uint8Array);
    toBytes(): Uint8Array;
    verify(domain: string, message: Uint8Array, signature: AuthoritySignature): void;
}
...
export class Ciphertext {
    ...
    static encrypt(message: Uint8Array, receiver_pk: PublicKey, sender_sk: SecretKey): Ciphertext;
...
export class Resource {
    ...
    [Symbol.dispose](): void;
    commitment(): Digest;
    static create(logic_ref: Digest, label_ref: Digest, quantity: bigint, value_ref: Digest, is_ephemeral: boolean, nonce: Digest, nk_cmt: NullifierKeyCommitment): Resource;
...
export class ResourceBuilder {
    free(): void;
    [Symbol.dispose](): void;
    static create_ephemeral_resource(props: CreateEphemeralResourceProps): ResourceBuilder;
    static create_persistent_resource(props: CreatePersistentResourceProps): ResourceBuilder;
    constructor(props: ResourceProps);
    toJson(): string;
    witness(): string;
    readonly resource: EncodedResource;
}
...
export class ResourceWithLabel {
    ...
    free(): void;
    [Symbol.dispose](): void;
    static fromEncrypted(payload: Uint8Array, sk_bytes: Uint8Array): ResourceWithLabel;
    /**
...
export class TransferLogicV2 {
     ...
     */
    static consumePersistentResourceLogic(props: ConsumedPersistentProps): TransferLogicV2;
    /**
     * Creates resource logic for a created persistent resource.
     */
    static create_persistent_resource_logic(props: CreatePersistentProps): TransferLogicV2;
    static migrateResourceLogic(props: MigrateResourceLogicProps): TransferLogicV2;
    toJson(): string;
    static readonly verifyingKey: string;
}
...
export interface InitOutput {
    ...
    readonly __wbg_resourcebuilder_free: (a: number, b: number) => void;
    readonly resourcebuilder_new: (a: any) => [number, number, number];
    readonly resourcebuilder_create_ephemeral_resource: (a: any) => [number, number, number];
    readonly resourcebuilder_create_persistent_resource: (a: any) => [number, number, number];
    readonly resourcebuilder_resource: (a: number) => any;
    readonly resourcebuilder_witness: (a: number) => [number, number];
    readonly resourcebuilder_toJson: (a: number) => [number, number, number, number];
    readonly __wbg_transferlogicv2_free: (a: number, b: number) => void;
    readonly transferlogicv2_verifyingKey: () => [number, number];
    readonly transferlogicv2_consumePersistentResourceLogic: (a: any) => [number, number, number];
    readonly transferlogicv2_create_persistent_resource_logic: (a: any) => [number, number, number];
    readonly transferlogicv2_migrateResourceLogic: (a: any) => [number, number, number];
    readonly transferlogicv2_toJson: (a: number) => [number, number, number, number];
    ...
    readonly secretkey_fromBase64: (a: number, b: number) => [number, number, number];
    readonly secretkey_toBase64: (a: number) => [number, number];
    readonly secretkey_fromHex: (a: number, b: number) => [number, number, number];
    ...
    readonly publickey_fromBase64: (a: number, b: number) => [number, number, number];
    ...
    readonly publickey_toAffinePointBytes: (a: number) => [number, number, number, number];
    readonly publickey_fromAffinePointBytes: (a: number, b: number) => [number, number, number];
    ...
    readonly ciphertext_encrypt: (a: number, b: number, c: number, d: number) => [number, number, number];
    readonly ciphertext_decrypt: (a: number, b: number) => [number, number, number, number];
    ...
    readonly nullifierkey_fromBase64: (a: number, b: number) => [number, number, number];
    readonly nullifierkey_default: () => number;
    readonly __wbg_nullifierkeycommitment_free: (a: number, b: number) => void;
    readonly nullifierkeycommitment_new: (a: number, b: number) => [number, number, number];
    readonly nullifierkeycommitment_inner: (a: number) => number;
    readonly nullifierkeycommitment_toBase64: (a: number) => [number, number];
    readonly nullifierkeycommitment_fromBase64: (a: number, b: number) => [number, number, number];
    ...
    readonly initialroot_base64: () => [number, number];
    readonly initialroot_hex: (a: number) => [number, number];
    ...
    readonly authoritysigningkey_authorize: (a: number, b: number, c: number, d: number) => [number, number, number];
    readonly authoritysigningkey_toBytes: (a: number) => [number, number];
    readonly authoritysigningkey_fromBytes: (a: number, b: number) => [number, number, number];
    readonly __wbg_authoritysignature_free: (a: number, b: number) => void;
    readonly authoritysignature_toBytes: (a: number) => [number, number];
    readonly authoritysignature_fromBytes: (a: number, b: number) => [number, number, number];
    readonly authoritysignature_fromBase64: (a: number, b: number) => [number, number, number];
    readonly __wbg_authorityverifyingkey_free: (a: number, b: number) => void;
    readonly authorityverifyingkey_new: (a: number, b: number) => [number, number, number];
    readonly authorityverifyingkey_fromSigningKey: (a: number) => number;
    readonly authorityverifyingkey_verify: (a: number, b: number, c: number, d: number, e: number, f: number) => [number, number];
    readonly authorityverifyingkey_fromHex: (a: number, b: number) => [number, number, number];
    readonly authorityverifyingkey_fromBase64: (a: number, b: number) => [number, number, number];
    ...
    readonly resource_empty: () => number;
    ...
    readonly merkletree_toWitness: (a: number) => [number, number, number, number];
    readonly __wbg_merklepath_free: (a: number, b: number) => void;
    readonly merklepath_new: () => number;
    readonly merklepath_encode: (a: number) => any;
